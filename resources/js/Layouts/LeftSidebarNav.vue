            ...
            <div class="sidebar-section">
                <ul class="nav nav-sidebar mb-4" data-nav-type="accordion">
                   ...
                   <!-- <li class="nav-item-header">
                    ...
                    <li class="nav-item">
                        <inertia-link :href="route('website.page.landing')" class="nav-link" :class="{ 'active': $page.url.startsWith('/website') }">
                            <i class="ph-stack"></i>
                            <span>Our Solutions</span>
                        </inertia-link>
                    </li>
                    ...
                    <!-- Customer Panel -->
                    <li class="nav-item-header">
                        <div class="text-uppercase fs-sm lh-sm opacity-50 sidebar-resize-hide">Additional Panel</div>
                        <i class="ph-dots-three sidebar-resize-show"></i>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <inertia-link :href="route('media.index')" class="nav-link" :class="{ 'active' : route().current('media.index') }" >
                            <i class="ph-upload"></i>
                            <span>Uploads</span>
                        </inertia-link>
                    </li>
