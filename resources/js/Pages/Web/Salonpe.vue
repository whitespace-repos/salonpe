            ...
            <div class="container">
                <div class="add-banner">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-4 g-4">
                        ...
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none bg-warning">                                
                                <div class="card-img-overlay text-center top-20">
                                    <div class="border border-white border-2 py-3 bg-warning">
                        ...
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none">
                                ...
                                <img src="/storage/uploads/1688105047-1688064159-pexels-obsahovka-obsahovka-4449799.jpg" class="img-fluid" alt="...">
